...
export class DroppableDirective {
  private readonly uiTreenodeDragoverClassName = 'p-treenode-dragover';
  ...
  dropCallback: () => void = () => {
    ...
    document.querySelectorAll('.p-treenode-selectable *').forEach((el: HTMLElement) => el.style.pointerEvents = 'auto');
