...
var EncryptionProvider = /** @class */ (function () {
    ...
    EncryptionProvider.encryptString = function (plaintext, password) {
    ...
    EncryptionProvider.decryptString = function (base64CiphertextAndNonceAndSalt, password) {
        // Decode the base64.
    ...
    EncryptionProvider.encrypt = function (plaintext, key) {
    ...
    EncryptionProvider.decrypt = function (ciphertextAndNonce, key) {
    ...
    EncryptionProvider.ALGORITHM_NAME = 'aes-256-gcm';
    EncryptionProvider.ALGORITHM_NONCE_SIZE = 12;
    EncryptionProvider.ALGORITHM_TAG_SIZE = 16;
    EncryptionProvider.ALGORITHM_KEY_SIZE = 32;
    EncryptionProvider.PBKDF2_NAME = "sha256";
    EncryptionProvider.PBKDF2_SALT_SIZE = 32;
    EncryptionProvider.PBKDF2_ITERATIONS = 100000;
    return EncryptionProvider;
}());
exports.EncryptionProvider = EncryptionProvider;
//# sourceMappingURL=encryption-provider.js.map