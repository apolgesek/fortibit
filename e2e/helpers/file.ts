...
export function setupTestFiles() {
	...
	copyFileSync('./e2e/files/templates/product.json', join(configPath, 'product.json'));
	copyFileSync('./e2e/files/templates/workspaces.json', join(configPath, 'workspaces.json'));
}
